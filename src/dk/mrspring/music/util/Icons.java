...
public class Icons
{
    public static Icon trash = new Icon(1, 1,
            new Quad(0.2F, 0.8F, 0.8F, 0.8F, 0.8F, 0.9F, 0.2F, 0.9F),
            new Quad(0.75F, 0.2F, 0.9F, 0.2F, 0.8F, 0.9F, 0.7F, 0.8F),
            new Quad(0.1F, 0.2F, 0.25F, 0.2F, 0.3F, 0.8F, 0.2F, 0.9F),
            new Quad(0.4F, 0.2F, 0.6F, 0.2F, 0.575F, 0.8F, 0.425F, 0.8F),
            new Quad(0.05F, 0.15F, 0.95F, 0.15F, 0.95F, 0.3F, 0.05F, 0.3F),
            new Quad(0.35F, 0F, 0.65F, 0F, 0.65F, 0.1F, 0.35F, 0.1F)
    );
    ...
    public static Icon right_arrow = new Icon(1, 1,
            new Quad(0.3F, 0.5F, 0F, 0F, 1F, 0.5F, 0F, 1F)
    );
}
